...
<li>Scroll down to <b>Less secure app access</b> and set it <b>ON</b></li>
      ...
      array (
        ...
        'offline_mode_instruction' => 'Enter offline payment instructions',
          'momo_mode' => 'Mobile Money Payment Method',
          'momo_mode_note' => 'User gets assistance for Mobile Money payment via admin',
          'momo_mode_instruction' => 'Enter Mobile Money payment instructions',

          'bank_mode' => 'Bank Deposit Payment Method',
          'bank_mode_note' => 'User gets assistance for Bank Deposit payment via admin',
          'bank_mode_instruction' => 'Enter Bank Deposit payment instructions',
        'key' => 'API Key',
        'secret' => 'API Secret',
        'client_id' => 'Client ID',
...
<b>Live</b> = Will be used with you Live PayUMoney credentials to make actual transaction with normal users with PayUMoney account.<br><strong>If you set this payment gateway then set your currency as INR</strong>',
  ...
  array (
    ...
    array (
      ...
      'momo_payment' => 'Mobile Money Payment',
      'momo_payment_note' => 'In this payment method our executives will contact you and give you instructions regarding payment and course purchase.',
      'bank_payment' => 'Bank Deposit Payment',
      'sponsor_payment' => 'Sponsor Deposit Payment',
      'bank_payment_note' => 'In this payment method you will deposit the money on our Company Bank account then fill this Form.',
      'sponsor_payment_note' => 'In this payment method you will  fill this Form and Upload Sponsorship document.',
      ...
      'sponsor_request' => 'Your Sponsor payment Detail received successfully! check your registered email for further details.',
