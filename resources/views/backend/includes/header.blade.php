<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
        <img class="navbar-brand-full" src="{{asset('img/frontend/logo.png')}}"  height="25" alt="Square Logo">
        <img class="navbar-brand-minimized" src="{{asset('img/frontend/logo.png')}}" height="30" alt="Square Logo">
    </a>
