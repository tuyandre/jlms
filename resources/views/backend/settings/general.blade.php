                ...
                <div id="payment_settings" class="tab-pane container fade">
                    <div class="row mt-4 mb-4">
                        <div class="col">
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.payment_settings.bank_mode'))->class('col-md-3 form-control-label')}}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('payment_bank_active', config('payment_bank_active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')
                                    ...
                                    <small>
                                        <i> {{ __('labels.backend.general_settings.payment_settings.bank_mode_note')}}</i>
                                    </small>
                                    {{ html()->textarea('payment_bank_instruction',config('payment_bank_instruction'))
                                            ->class('form-control')->placeholder(__('labels.backend.general_settings.payment_settings.bank_mode_instruction'))
                                        }}
                                </div>
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.payment_settings.momo_mode'))->class('col-md-3 form-control-label')}}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('payment_momo_active', config('payment_momo_active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')
                                    ...
                                    <small>
                                        <i> {{ __('labels.backend.general_settings.payment_settings.momo_mode_note')}}</i>
                                    </small>
                                    {{ html()->textarea('payment_momo_instruction',config('payment_momo_instruction'))
                                            ->class('form-control')->placeholder(__('labels.backend.general_settings.payment_settings.momo_mode_instruction'))
                                        }}
                                </div>
